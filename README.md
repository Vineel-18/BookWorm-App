...
A fully functional Android bookstore app built with **100% Kotlin + Jetpack Compose**.
...
3. ⚙️ Let Gradle sync finish
4. ▶️ Hit Run on any device or emulator (Android 7+)
